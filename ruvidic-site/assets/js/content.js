window.siteContent = {
  ...
  about: {
    ...
    timeline: [
      { year: "2002–2016", role: "Professional Soldier", org: "Serbian Army", desc: "14 years of active service. Operations, logistics, training.", active: false },
      { year: "during service", role: "UN Peacekeeper", org: "MINUSCA — Central African Republic", desc: "7-month deployment with UN peacekeeping mission MINUSCA.", active: false },
      ...
      { year: "2021–present", role: "IT & Facility Lead", org: "Interventure d.o.o.", desc: "Security, GCP, automations, ISO 27001/27701/9001, BCP, IRP, fire safety, training.", active: true }
    ]
  },
  expertise: [
  ...
  contact: {
    ...
    links: [
      ...
      {type:"a", href:"mailto:zoran@ruvidic.com", icon:"Email", label:"zoran@ruvidic.com", sub:"↗"},
