window.siteContent = {
  ...
  about: {
    ...
    timeline: [
      ...
      { year: "2021–present", role: "IT & Facility Lead", org: "Interventure d.o.o.", desc: "Security, GCP/GWS, Azure/Intune, CI/CD, ISO 27001/27701/9001, BCP, IRP, fire safety, training.", active: true }
    ]
  },
  expertise: [
  ...
  projects: [
    ...
    { title: "OverClaw - AI configuration", text: "Configuration of AI server with Agents for sales purposes.", tags: [{label:"AI", class:"t-green"}], status: {label:"AI", class:"t-green"} }
